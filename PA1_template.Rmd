...
s1a <- round(sum(s1$steps, na.rm = TRUE)/nrow(s1),0)
```

There was a total of  `r s1a` steps taken PER day  
...
5-minute time interval at `r s2.maxsteps.interval` minutes has an average of `r s2.maxsteps'.
